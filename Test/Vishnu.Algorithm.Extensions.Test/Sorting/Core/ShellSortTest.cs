...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class ShellSortTest
    {
        ...
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseShell(data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseShell( data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.UseShell(d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseShell(data, new DateTimeComparer());
        ...
        public void Class_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseShell(data, new PersonAgeComparer());
