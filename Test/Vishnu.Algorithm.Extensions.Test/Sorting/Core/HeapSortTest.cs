...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class HeapSortTest
    {
        ...
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseHeap( data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseHeap(data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void Class_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseHeap(data, new PersonAgeComparer());
