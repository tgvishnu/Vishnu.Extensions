...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class HeapSortTest
    {
        ...
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Heap, data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Heap, data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.Sort(SortingTypes.Heap, d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Heap, data, new DateTimeComparer());
