...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class SelectionSortTest
    {
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseSelection(data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.UseSelection(d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseSelection(data, new DateTimeComparer());
        ...
        public void Class_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseSelection(data, new PersonAgeComparer());
