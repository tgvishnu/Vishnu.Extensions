...
{
    [TestFixture]
    public class QuickSortLastPivotTest
    {
        [Test]
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseQuickLastPivot( data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseQuickLastPivot(data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.UseQuickLastPivot(d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseQuickLastPivot(data, new DateTimeComparer());
        ...
        public void Class_Sort_Test()
        {
            ...
            Algorithm.Sorting.UseQuickLastPivot(data, new PersonAgeComparer());
