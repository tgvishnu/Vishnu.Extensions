...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class MergerSortTest
    {
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Merge, data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.Sort(SortingTypes.Merge, d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Merge, data, new DateTimeComparer());
