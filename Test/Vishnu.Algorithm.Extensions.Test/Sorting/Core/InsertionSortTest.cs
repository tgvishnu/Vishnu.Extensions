...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class InsertionSortTest
    {
        ...
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Insertion, data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Insertion, data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Insertion, data, new DateTimeComparer());
