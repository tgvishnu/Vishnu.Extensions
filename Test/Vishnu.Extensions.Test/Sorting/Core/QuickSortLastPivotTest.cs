...
namespace Vishnu.Extensions.Test.Sorting.Core
{
    ...
    public class QuickSortLastPivotTest
    {
        ...
        public void Integer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Quick_LastPivot, data, new IntegerComparer());
        ...
        public void StringLenghtComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Quick_LastPivot, data, new StringLengthComparer());
            Assert.AreEqual(expectedData, data);
        }
        ...
        public void AsciiValueComparer_Sort_Test()
        {
            string d = "dsaf";
            string ed = "adfs";
            d = Algorithm.Sorting.Sort(SortingTypes.Insertion, d);
        ...
        public void DateTimeComparer_Sort_Test()
        {
            ...
            Algorithm.Sorting.Sort(SortingTypes.Quick_LastPivot, data, new DateTimeComparer());
