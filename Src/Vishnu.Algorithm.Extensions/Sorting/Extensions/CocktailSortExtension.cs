...
namespace Vishnu.Extension.Sorting
{
    ...
    public static class CocktailSortExtension
    {
        ...
        public static void UseCocktail<T>(this ISort sort, T[] input, IComparer<T> comparer)
        {
        ...
        /// <param name="input">input data</param>
        /// <param name="comparer">Comparer must returns '1' if the first element is greater than next</param>
        public static void UseCocktail<T>(this ISort sort, ISortingAlgorithmFactory sortingAlgorithmFactory, T[] input, IComparer<T> comparer)
        {
        ...
        public static string UseCocktail(this ISort sort, string input, IComparer<char> comparer = null)
        {
        ...
        /// <param name="comparer">Comparer must returns '1' if the first element is greater than next</param>
        /// <returns>The ascending ordered content</returns>
        public static string UseCocktail(this ISort sort, ISortingAlgorithmFactory sortingAlgorithmFactory, string input, IComparer<char> comparer = null)
        {
