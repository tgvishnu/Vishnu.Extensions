...
namespace Vishnu.Extension.Sorting
{
    ...
    public static class InsertionSortExtension
    {
        ...
        public static void UseInsertion<T>(this ISort sort, T[] input, IComparer<T> comparer)
        {
            sort.Sort<T>(SortingTypes.Insertion, input, comparer);
        }
        ...
        /// <param name="input">input data</param>
        /// <param name="comparer">Comparer must returns '1' if the first element is greater than next</param>
        public static void UseInsertion<T>(this ISort sort, ISortingAlgorithmFactory sortingAlgorithmFactory, T[] input, IComparer<T> comparer)
        {
