...
namespace Vishnu.Extensions.Sorting
{
    ...
    public static class InsertionSortExtension
    {
        ...
        public static void UseInsertion<T>(this ISorting sort, T[] input, IComparer<T> comparer)
        {
        ...
        public static string UseInsertion(this ISorting sort, string input, IComparer<char> comparer = null)
        {
